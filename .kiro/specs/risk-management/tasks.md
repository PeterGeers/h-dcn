...
- [x] 1. AWS SSO Profile Configuration
  - [x] 1.1 Configure AWS SSO session and profile in `~/.aws/config`
  ...
  - [x] 1.2 Verify SSO profile permissions match current static credentials
  ...
  - [x] 1.3 Remove static credentials from `~/.aws/credentials`
...
- [ ] 2. Google Workload Identity Federation (Lambda)
  - [x] 2.1 Create Google Cloud WIF resources (pool, provider, SA binding)
  ...
  - [x] 2.2 Modify `sync_google_calendar/app.py` to use WIF authentication
  ...
  - [x] 2.3 Update SAM template for WIF migration
  ...
  - [x] 2.4 Write unit tests for WIF credential builder
...
- [x] 4. Google Service Account Consolidation (Local Dev)
  - [x] 4.1 Audit and consolidate Google service accounts
  ...
  - [x] 4.2 Set org policy for 90-day key expiry
  ...
  - [x] 4.3 Create verification script for service account connectivity
  ...
  - [x] 4.4 Create rotation reminder and document inventory
...
- [x] 5. PowerShell Shell History Secret Prevention
  - [x] 5.1 Implement AddToHistoryHandler in PowerShell `$PROFILE`
  ...
  - [x] 5.2 Implement Python secret filter module for testing
  ...
  - [x] 5.3 Write property test: Secret pattern detection
  ...
  - [x] 5.4 Write property test: Non-secret passthrough
  ...
  - [x] 5.5 Write unit tests for secret filter edge cases
  ...
  - [x] 5.6 Implement one-time history cleanup script
