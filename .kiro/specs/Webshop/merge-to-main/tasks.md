...
- [x] 1. Create Pull Request
  - [x] 1.1 Ensure working directory is clean and create PR
...
- [x] 2. Pre-merge validation
  - [x] 2.1 Wait for CI checks to pass
...
- [x] 3. Checkpoint - CI validation
  - Ensure CI checks pass. Ask the user if questions arise.

- [x] 4. Run data migration
  - [x] 4.1 Execute migration dry-run
...
- [x] 5. Checkpoint - Migration complete
  - Ensure migration applied successfully. Ask the user if questions arise.

- [x] 6. Squash-merge the PR
  - [x] 6.1 Execute squash-merge with branch deletion
    - Run: `gh pr merge --squash --delete-branch`
    - Verify confirmation that PR was merged and branch deleted
    - _Requirements: 4.1, 4.2, 4.3_

- [x] 7. Verify deployments
  - [x] 7.1 Monitor deployment workflow runs
...
- [x] 8. Final checkpoint - Merge complete
