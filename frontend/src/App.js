...
const ParameterManagement = lazy(() => import('./pages/ParameterManagement'));
const WebshopPage = lazy(() => import('./modules/webshop/WebshopPage'));
const ProductManagementPage = lazy(() => import('./modules/products/ProductManagementPage'));
const MemberAdminPage = lazy(() => import('./modules/members/MemberAdminPage'));
const EventAdminPage = lazy(() => import('./modules/events/EventAdminPage'));
...
function NavigationHeader({ signOut, user }) {
