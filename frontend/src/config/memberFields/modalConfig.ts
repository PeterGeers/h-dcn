    ...
    sections: [
      {
        ...
        fields: [
          ...
          { fieldKey: 'korte_naam', visible: true, readOnly: true, order: 4, span: 2 },
          { fieldKey: 'initialen', visible: true, order: 5, span: 1 },
          { fieldKey: 'geboortedatum', visible: true, order: 6, span: 1 },
          { fieldKey: 'geslacht', visible: true, order: 7, span: 1 },
