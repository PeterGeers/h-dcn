...
describe('Property 2: Filterable table pipeline equivalence', () => {
  /**
   * **Validates: Requirements 1.3**
   *
...
// ---------------------------------------------------------------------------
// Property: Column filtering produces matching rows
// ---------------------------------------------------------------------------

describe('Property: Column filtering produces matching rows', () => {
  /**
   * **Validates: Requirements 1.1**
   *
   * For any dataset and any non-empty filter string applied to a column,
   * all rows in the filtered output SHALL contain the filter string
...
// ---------------------------------------------------------------------------
// Property: Column sorting produces ordered output
// ---------------------------------------------------------------------------

describe('Property: Column sorting produces ordered output', () => {
  /**
   * **Validates: Requirements 1.3**
   *
   * For any dataset and any sortable column, after applying a sort in
   * ascending direction, each consecutive pair of rows SHALL have the sorted
   * column value in non-decreasing order. Nullish values always sort to end.
   */
