...
export default function AdvancedImageEditor({ isOpen, onClose, imageUrl, onSave }: AdvancedImageEditorProps) {
  ...
  const drawCropOverlay = useCallback((ctx: CanvasRenderingContext2D, canvasWidth: number, canvasHeight: number, currentCrop: CropArea = cropArea) => {
