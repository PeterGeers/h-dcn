...
import { ClubRegistry } from '../types/presmeet.types';
...
// Mock ApiService (used by OnboardingFlow)
const mockGetClubRegistry = jest.fn();
const mockAssignClub = jest.fn();

jest.mock('../../../services/apiService', () => ({
  ApiService: {
    get: (...args: any[]) => mockGetClubRegistry(...args),
    post: (...args: any[]) => mockAssignClub(...args),
  },
}));
...
describe('OnboardingFlow', () => {
  ...
  it('calls assignClub when a club is clicked', async () => {
    ...
    expect(mockAssignClub).toHaveBeenCalledWith('/presmeet/clubs/assign', { club_id: 'amsterdam' });
  });
