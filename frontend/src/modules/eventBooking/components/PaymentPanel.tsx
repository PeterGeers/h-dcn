 ...
 * eventBookingApi.pay() endpoint. On success, redirects to Mollie's checkout_url.
 *
...
import { Order, PaymentStatus } from '../types/eventBooking.types';
...
const PaymentPanel: React.FC<PaymentPanelProps> = ({ order, onPaymentInitiated }) => {
  ...
  const handlePay = async () => {
    setIsLoading(true);
    try {
      const response = await eventBookingApi.pay(order.order_id);
