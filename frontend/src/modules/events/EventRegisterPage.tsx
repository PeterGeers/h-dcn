...
import PasswordGate, { RegistryConfig, VerifyPasswordResult } from '../presmeet/components/PasswordGate';
import RegistrySelector from '../presmeet/components/RegistrySelector';
import ClaimAction from '../presmeet/components/ClaimAction';
