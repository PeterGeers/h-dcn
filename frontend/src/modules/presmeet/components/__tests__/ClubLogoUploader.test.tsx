...
import ClubLogoUploader from '../ClubLogoUploader';

const mockedUploadClubLogo = presmeetService.uploadClubLogo as jest.MockedFunction<
  typeof presmeetService.uploadClubLogo
>;
