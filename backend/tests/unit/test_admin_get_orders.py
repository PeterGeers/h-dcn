"""
Stub test for admin_get_orders handler.
...
sys.path.insert(0, os.path.join(os.path.dirname(__file__), '..', '..', 'handler', 'admin_get_orders'))
sys.path.insert(0, os.path.join(os.path.dirname(__file__), '..', '..', 'layers', 'auth-layer', 'python'))

from handler.admin_get_orders.app import lambda_handler
