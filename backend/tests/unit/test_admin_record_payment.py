"""
Stub test for admin_record_payment handler.
...
sys.path.insert(0, os.path.join(os.path.dirname(__file__), '..', '..', 'handler', 'admin_record_payment'))
sys.path.insert(0, os.path.join(os.path.dirname(__file__), '..', '..', 'layers', 'auth-layer', 'python'))

from handler.admin_record_payment.app import lambda_handler
