"""
MIGRATION TEMPLATE FOR: get_customer_orders
...
if not is_authorized:
    return error_response
        ...
        log_successful_access(user_email, user_roles, 'get_customer_orders')
        ...
        return create_error_response(500, f"Internal server error in get_customer_orders")
