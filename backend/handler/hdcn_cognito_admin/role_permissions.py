...
DEFAULT_ROLE_PERMISSIONS = {
    ...
    # Example: Members_CRUD + Regio_All instead of Members_CRUD_All
}
...
# NOTE: These mappings are for reference only - the old roles have been removed
LEGACY_TO_NEW_ROLE_MAPPING = {
    # Reference mappings for documentation purposes
...
ORGANIZATIONAL_ROLE_COMBINATIONS = {
    ...
    'Regional_Chairman_Region1': [
        ...
        'Products_Read', 'Regio_All',  # Products are national
...
def can_edit_field(roles, field_name, is_own_record=False):
    ...
    # Check for legacy _All roles (backward compatibility) - REMOVED
    # Note: Legacy _All roles have been cleaned up as part of role migration
    # All users should now use the new Permission + Region role structure
