"""
MIGRATION TEMPLATE FOR: generate_member_parquet
...
if not is_authorized:
    return error_response
        ...
        log_successful_access(user_email, user_roles, 'generate_member_parquet')
        ...
        print(f"Error in generate_member_parquet: {str(e)}")
        return create_error_response(500, f"Internal server error in generate_member_parquet")
