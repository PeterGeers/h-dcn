"""
MIGRATION TEMPLATE FOR: download_parquet
OLD ROLES: ['Members_CRUD_All', 'Members_Read_All']
NEW PERMISSIONS: ['members_update', 'members_list', 'members_read', 'members_export', 'members_delete', 'members_create']

MIGRATION NOTES:
- 'Members_CRUD_All' -> check permissions: ['members_create', 'members_read', 'members_update', 'members_delete', 'members_export']
- 'Members_Read_All' -> check permissions: ['members_read', 'members_list', 'members_export']
"""
...
is_authorized, error_response, regional_info = validate_permissions_with_regions(
    user_roles, ['members_update', 'members_list', 'members_read', 'members_export', 'members_delete', 'members_create'], user_email, resource_context
)
if not is_authorized:
    return error_response
        
        # Log successful access
        log_successful_access(user_email, user_roles, 'download_parquet')
        ...
        print(f"Error in download_parquet: {str(e)}")
        return create_error_response(500, f"Internal server error in download_parquet")
