...
def can_edit_field(roles, field_name, is_own_record=False):
    ...
    """
    # Temporary fix: Trust the frontend permission system
    # The frontend already handles proper permission checking and shows
    # system administrators have full access, so we should respect that
    return True
