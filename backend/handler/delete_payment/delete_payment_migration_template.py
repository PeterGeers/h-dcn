"""
MIGRATION TEMPLATE FOR: delete_payment
...
if not is_authorized:
    return error_response
        ...
        log_successful_access(user_email, user_roles, 'delete_payment')
        ...
        return create_error_response(500, f"Internal server error in delete_payment")
