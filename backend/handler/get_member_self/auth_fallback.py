"""
Fallback authentication utilities for get_member_self handler
This is a copy of the shared auth_utils.py for cases where the layer isn't available
"""
...
def validate_permissions(user_roles, required_permissions, user_email=None, resource_context=None):
    ...
    try:
        ...
        role_permissions = {
            ...
            'verzoek_lid': ['members_self_read']  # Applicants can check their own status
