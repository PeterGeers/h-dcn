"""
MIGRATION TEMPLATE FOR: update_payment
OLD ROLES: ['Members_CRUD'] (DEPRECATED _All ROLES REMOVED)
...
if not is_authorized:
    return error_response
        ...
        print(f"Error in update_payment: {str(e)}")
        return create_error_response(500, f"Internal server error in update_payment")
