...
Tests the actual handler functions with authentication to ensure they work correctly.
This simulates the actual Lambda execution environment.
"""
...
def test_create_member_handler():
    ...
    with patch('boto3.resource') as mock_boto3:
        ...
        with patch.dict(os.environ, {'DYNAMODB_TABLE': 'Members'}):
            # Import the handler after mocking
            from handler.create_member.app import lambda_handler
            ...
            test_cases = [
                ...
                {
                    "name": "User with wrong permission type",
                    "email": "events_admin@hdcn.nl",
...
def test_options_request_handling():
    ...
    with patch('boto3.resource'):
        from handler.get_events.app import lambda_handler as get_events_handler
    ...
    with patch('boto3.resource'), patch.dict(os.environ, {'DYNAMODB_TABLE': 'Members'}):
        from handler.create_member.app import lambda_handler as create_member_handler
...
def main():
    ...
    print("🔐 Handler Integration Test")
    print("=" * 50)
    ...
    try:
        ...
        print("\n" + "=" * 50)
        print("🎉 Handler integration tests completed!")
        print("=" * 50)
